...
<span class="header_menu"><img alt="" width="100" height="120" src="img/layout/NOTICE.gif" onmouseover="this.src='img/layout/NOTICE_over.gif'" onmouseout="this.src='img/layout/NOTICE.gif'"></span>
...
<span class="header_menu"><img alt="" width="100" height="120" src="img/layout/EVENT.gif" onmouseover="this.src='img/layout/GALLERY_over.gif'" onmouseout="this.src='img/layout/GALLERY.gif'"></span>
